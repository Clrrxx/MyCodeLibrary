...
/* Write your code here */
    // returns 1 when 2 circles intersect 0 when they do not => if total dist between circle 1 and 2  < sum of radius => they intersect
    double a, b;
    double sum;
...
/* Write your code here */
    ...
    if ((*c1).radius > ((*c2).radius + sqrt(a*a + b*b))){
        return 1;
    }else{
        return 0;
    }
