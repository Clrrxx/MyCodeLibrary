...
# Write your code here #
    ...
    #while stack not empty -> pop item and print
    #-> push right child of popped item
    #-> push left child of popped item
    #right is push first to ensure left is processed first because stack is fifo
    ...
    while not isEmpty(stack):
        ...
        if hold.right:
            push(stack, hold.right)
        
        if hold.left:
            push(stack, hold.left)
